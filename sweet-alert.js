...
(function() {
	...
	function initialize() {
		var sweetHTML = '<div class="sweet-overlay" tabIndex="-1"></div><div class="sweet-alert" tabIndex="-1"><div class="icon error"><span class="x-mark"><span class="line left"></span><span class="line right"></span></span></div><div class="icon warning"> <span class="body"></span> <span class="dot"></span> </div> <div class="icon info"></div> <div class="icon success"> <span class="line tip"></span> <span class="line long"></span> <div class="placeholder"></div> <div class="fix"></div> </div> <div class="icon custom"></div> <h2>Title</h2><p>Text</p><input type="text" name="text-input"> <button class="cancel" tabIndex="2">Cancel</button><button class="confirm" tabIndex="1">OK</button></div>',
	...
	window.sweetAlert = window.swal = function() {
		...
		switch (typeof arguments[0]) {
			...
			case 'object':
				...
				params.showTextInput      = arguments[0].showTextInput || params.showTextInput;
				...
				callback = (typeof arguments[0].callback === 'function') ? arguments[0].callback : false;
		...
		fixVerticalPosition();
		openModal(params.showTextInput);
	...
	function setParameters(params) {
		...
		var $title = modal.querySelector('h2'),
				...
				$textInput = modal.querySelector('input'),
		...
		// Prompt / Text input
		modal.setAttribute('data-has-text-input', params.showTextInput);
	...
	function openModal(showTextInput) {

		showTextInput = showTextInput || false;
		...
		if (!showTextInput) {
			...
			var $textInput = modal.querySelector('input');
			$textInput.focus();
		}
	...
	function closeModal() {
		...
		var modal = getModal(),
			hasTextInput = modal.getAttribute('data-has-text-input');

		if (hasTextInput) {
			var strTextInput = $(modal.querySelector('input')).val();
		}

		if (typeof callback === 'function') {
			callback(strTextInput);
		}
